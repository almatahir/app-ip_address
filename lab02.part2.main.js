...
/**
 * Calculate and return the ipv4 and ipv6 IP address from a CIDR subnet.
 * @param {string} cidrStr - The IPv4 subnet expressed
 *                 in CIDR format.
 * @param {callback} callback - A callback function.
 * @return {Object} (reponse) - An IPv4 and IPV6 address.
 */
function getFirstIpAddress(cidrStr, callback) {
  ...
  if (!cidr.isValid()) {
    ...
    response.ipv4 = firstIpAddress,
    response.ipv6 = mappedAddress;
  }
